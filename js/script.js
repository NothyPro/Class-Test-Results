...
alexPointsDisplay = "Alex earned " + alexPoints + " points out of " + maxPoints;
console.log(alexPointsDisplay);
jessiePointsDisplay = "Jessie earned " + jessiePoints + " points out of " + maxPoints;
...
jessieMissedPointsDisplay = "Jessie missed " + jessieMissedPoints + " point(s).";
...
classAvgDisplay = "The class average was " + classAveragePoints + " points or " + classAveragePercent.toFixed(2) + "%.";
console.log(classAvgDisplay);

alexPoints = 75;
didAlexPass = !false;

alexPointsUpdated = "Alex failed initially but did extra credit. Their new score is " + alexPoints + " out of " + maxPoints
console.log(alexPointsUpdated);

listItemArray[13].innerHTML = alexPointsUpdated;
listItemArray[14].innerHTML = classAvgDisplay;
